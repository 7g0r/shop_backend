package com.ichmielewski.shop_backend.search;
...
import static com.ichmielewski.shop_backend.search.SearchOperation.*;
...
public class SpecificationBuilder<E extends AbstractEntity> implements Specification<E> {
    ...
    public SpecificationBuilder<E> and(SearchCriteria criteria) {
